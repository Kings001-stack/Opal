    ...
    <div className="max-w-[1400px] mx-auto p-6 lg:p-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <div className="flex items-center gap-2 text-gray-500 text-sm font-medium mb-3">
            ...
            <span className="uppercase tracking-widest text-xs">Social Proof</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight">
            Manage <span className="gradient-text">Testimonials</span>
          </h1>
          <p className="text-gray-400 mt-2">
            Display curated feedback from your clients to build trust.
          </p>
        </div>
      ...
      <div className="premium-card bg-white/[0.02] border-white/5 overflow-hidden">
        <div className="p-6 border-b border-white/5 bg-white/[0.01]">
          <h3 className="font-bold text-lg">Client Reviews ({testimonials?.length || 0})</h3>
        </div>
        <div className="p-0">
