      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="text-gray-500 text-base leading-relaxed max-w-sm font-light">
              ...
              <span className="text-white font-medium"> Opal</span>. We bridge
            ...
            <div className="flex gap-4">
              {[
                {
                  icon: Instagram,
                  href: "https://instagram.com/opal_ui_ux_1",
                  label: "Instagram",
                },
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 group">
                  <Mail
                    size={16}
                    className="text-[#E91E8C] mt-0.5 shrink-0 group-hover:scale-110 transition-transform"
                  />
                  <a
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-500 font-light">
                Join our elite network for exclusive design insights.
              </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-10 border-t border-white/5">
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-gray-600">
            © 2025 Opal. All Creative Rights Reserved.
          </p>
          <div className="flex items-center gap-8">
            <Link
              href="/admin/login"
              className="text-[10px] font-bold uppercase tracking-[0.3em] text-gray-600 hover:text-[#E91E8C] transition-colors"
            >
              Admin Access
            </Link>
            <Link
